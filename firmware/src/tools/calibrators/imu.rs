...
// allows for 3s of calibration at the update frequency with a little bit of a buffer
const MAX_CALIBRATION_STEPS: usize = (UPDATE_LOOP_FREQUENCY * 3.5) as usize;
